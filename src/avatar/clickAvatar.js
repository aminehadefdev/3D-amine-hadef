...
export function clickAvatar(avatar, camera, controls, renderer, scene, mixer) {
    ...
    const questions = [
        ...
        },
        {
            ...
            "id": "btn-question-" + uuidv4(),
            "actions": () => {
                talkAndStay("Heuu… peut-être 👀 Mais chut, on va dire que c’était pour tester la robustesse du système 🤫. Et ce n’était pas un site dont j’avais la charge, ça explique tout.")
            }
        },
        {
        ...
        },
        {
            ...
            "id": "btn-question-" + uuidv4(),
            "actions": () => {
                talkAndStay("Quand j’étais petit, je rêvais d’être éboueur 🚛✨, j’adorais leurs énormes camions qui faisaient vroum vroum partout 😎💨. Mais le code m’a vite appâté 💻🔥😄")
            }
        },
        {
        ...
        },
        {
            ...
            "id": "btn-question-" + uuidv4(),
            "actions": () => {
                talkAndStay("Pas expert, mais je discute souvent avec ChatGPT. Il me pique parfois mes blagues 😅.")
            }
        },
        {
